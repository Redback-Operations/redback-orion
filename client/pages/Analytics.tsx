  ...
  const generateReport = async (reportType: string, format: string = "txt") => {
    ...
    try {
      ...
      switch (format.toLowerCase()) {
        ...
        case "pdf":
        case "txt":
          const textContent = `AFL Analytics Report - ${reportType}
...
PLAYER PERFORMANCE
==================
${Object.entries(analysisData.playerStats)
  .map(
    ([player, stats]) =>
      `${player}:
...
This report was generated by AFL Analytics Platform.`;
      ...
      setReportsError(`Failed to generate ${reportType} report. Please try again.`);
    } finally {
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        {customReportFormat.toUpperCase()})
                      </Button>
                    </div>
                  </CardContent>
                </Card>
