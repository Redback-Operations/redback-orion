...
export default function Reports() {
  ...
  const filteredReports = availableReports.filter((report) => {
    ...
    const matchesFormat = selectedFormat === "all" || report.format.toLowerCase() === selectedFormat.toLowerCase();
  ...
  const generateNewReport = async () => {
    ...
    switch (reportFormat) {
      ...
      case "csv":
        const csvHeader = "Report Name,Type,Category,Date,Size,Format,Status,Downloads\n";
        const csvData = availableReports.map(report => 
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Player Analysis">Player Analysis</SelectItem>
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <CardTitle className="text-lg leading-6 mb-2">{report.name}</CardTitle>
                ...
                <Card>
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-gray-600">
                      No reports match your current filter criteria. Try adjusting your filters or generate a new report.
                    </p>
                  </CardContent>
                </Card>
              )}
                      ...
                      <div>
                        ...
                        <Select value={reportType} onValueChange={setReportType}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="tactical">Tactical Review</SelectItem>
                            <SelectItem value="video">Video Analysis</SelectItem>
                            <SelectItem value="season">Season Summary</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
