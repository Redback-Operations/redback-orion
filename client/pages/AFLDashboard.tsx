...
ANALYSIS SUMMARY:
${selectedAnalysisType === 'highlights' ? 'Key moments and highlights have been identified from the video footage.' : ''}
${selectedAnalysisType === 'player' ? 'Player movements and performance metrics have been tracked throughout the match.' : ''}
${selectedAnalysisType === 'tactics' ? 'Tactical patterns and strategies have been analyzed and documented.' : ''}
${selectedAnalysisType === 'performance' ? 'Performance metrics have been calculated for all players.' : ''}
${selectedAnalysisType === 'crowd' ? 'Crowd reactions and engagement levels have been measured.' : ''}

DETAILED INSIGHTS:
- Video processing completed successfully
- Focus areas analyzed: ${selectedFocusAreas.length > 0 ? selectedFocusAreas.join(', ') : 'General analysis'}
- Analysis timestamp: ${new Date().toISOString()}

This report was generated by AFL Analytics Platform.
`;

    downloadText(reportContent, `AFL_Video_Analysis_${selectedAnalysisType}_${Date.now()}`);
  };
  ...
  const handleDownloadVideoClips = () => {
    ...
    // Simulate downloading video clips metadata
...
EXTRACTED CLIPS:
- Clip 1: Key moment at 00:12:34 (Duration: 15s)
- Clip 2: Highlight play at 00:28:45 (Duration: 20s)
- Clip 3: Tactical sequence at 00:41:12 (Duration: 30s)
- Clip 4: Performance moment at 01:05:23 (Duration: 18s)

NOTE: In a production environment, this would download actual video clip files.
Currently showing metadata export for demonstration purposes.

Total clips identified: 4
Total duration: 83 seconds
Export format: Metadata (txt)
`;
