                      ...
                      {['kicks', 'handballs', 'marks', 'tackles', 'goals'].map((stat) => (
                        <div key={stat} className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span>
                              {selectedPlayer[stat as keyof typeof selectedPlayer]} vs {comparisonPlayer[stat as keyof typeof comparisonPlayer]}
                            </span>
                          </div>
                          <div className="flex gap-2">
                            <div className="flex-1">
                              <Progress 
                                value={(selectedPlayer[stat as keyof typeof selectedPlayer] as number / Math.max(selectedPlayer[stat as keyof typeof selectedPlayer] as number, comparisonPlayer[stat as keyof typeof comparisonPlayer] as number)) * 100} 
                                className="h-2" 
                              />
                            ...
                            <div className="flex-1">
                              <Progress 
                                value={(comparisonPlayer[stat as keyof typeof comparisonPlayer] as number / Math.max(selectedPlayer[stat as keyof typeof selectedPlayer] as number, comparisonPlayer[stat as keyof typeof comparisonPlayer] as number)) * 100} 
                                className="h-2" 
                              />
