          ...
          {modalPlayerCard && (
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="absolute top-2 right-2 z-30 bg-black/50 text-white hover:bg-black/70 rounded-full w-8 h-8 p-0"
              ...
              <div className="relative">
                ...
                <div className="absolute top-4 right-16 z-20">
                  <div className="bg-black/70 text-white px-3 py-2 rounded text-lg font-bold">
                    #{modalPlayerCard.number}
                  </div>
                </div>

                <div className={`relative h-[600px] rounded-xl overflow-hidden shadow-2xl border-4 border-white bg-gradient-to-b ${modalPlayerCard.background}`}>
                  {/* Background Image - More Visible */}
                  <img
                    src={modalPlayerCard.image}
                    alt={modalPlayerCard.name}
                  ...
                  <div className="absolute top-16 left-4 right-16 z-10">
                    <h2 className="text-white font-bold text-3xl leading-tight mb-2 drop-shadow-lg">
                      {modalPlayerCard.name}
                    </h2>
                    <p className="text-white/90 text-xl font-medium drop-shadow-lg">
                      {modalPlayerCard.team}
                    </p>
                    <div className="mt-2 px-3 py-1 bg-white/20 backdrop-blur-sm rounded-full inline-block">
                      <span className="text-white text-sm font-medium">Position: Midfielder</span>
                    </div>
                  </div>

                  {/* Detailed Stats - Middle */}
                  <div className="absolute top-1/2 left-4 right-4 transform -translate-y-1/2 z-10">
                    <div className="bg-black/80 backdrop-blur-lg rounded-xl p-6 border border-white/20">
                      <h3 className="text-white font-bold text-lg mb-4 text-center">PERFORMANCE STATS</h3>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center">
                          <div className="text-white/70 text-sm uppercase tracking-wide">Goal Accuracy</div>
                          <div className="text-white font-bold text-2xl">{modalPlayerCard.stats.goalAccuracy}%</div>
                        </div>
                        <div className="text-center">
                          <div className="text-white/70 text-sm uppercase tracking-wide">Disposals</div>
                          <div className="text-white font-bold text-2xl">{modalPlayerCard.stats.disposals}</div>
                        </div>
                        <div className="text-center">
                          <div className="text-white/70 text-sm uppercase tracking-wide">Handballs</div>
                          <div className="text-white font-bold text-2xl">{modalPlayerCard.stats.handballs}</div>
                        </div>
                        <div className="text-center">
                          <div className="text-white/70 text-sm uppercase tracking-wide">Efficiency</div>
                      ...
                      <div className="mt-4 pt-4 border-t border-white/20">
                        <div className="grid grid-cols-4 gap-2 text-center">
                          <div>
                            <div className="text-white font-bold text-lg">{modalPlayerCard.stats.kicks}</div>
                            <div className="text-white/70 text-xs uppercase">Kicks</div>
                          </div>
                          <div>
                            <div className="text-white font-bold text-lg">{modalPlayerCard.stats.marks}</div>
                            <div className="text-white/70 text-xs uppercase">Marks</div>
                          </div>
                          <div>
                            <div className="text-white font-bold text-lg">{modalPlayerCard.stats.tackles}</div>
                            <div className="text-white/70 text-xs uppercase">Tackles</div>
                          </div>
                          <div>
                            <div className="text-white font-bold text-lg">3</div>
                            <div className="text-white/70 text-xs uppercase">Goals</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Bottom Action Bar */}
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-red-600 to-red-700 p-6 z-10">
                    <div className="flex items-center justify-between">
                      <div className="text-white">
                        <div className="font-bold text-lg">Season 2024</div>
                        <div className="text-white/80 text-sm">Match Performance</div>
                      </div>
                      <div className="flex gap-2">
