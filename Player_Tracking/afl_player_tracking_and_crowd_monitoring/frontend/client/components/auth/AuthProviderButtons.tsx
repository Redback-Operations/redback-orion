...
export function AuthProviderButtons({
  ...
  return (
    <div className="space-y-3">
      <Button type="button" variant="outline" className="w-full relative" onClick={onGoogle}>
      ...
      <Button type="button" variant="outline" className="w-full relative bg-black text-white hover:bg-gray-800" onClick={onApple}>
