...
interface TeamMatchTabProps {
  ...
  teamCompare: TeamComparison;
  teamTeams: string[];
}

export default function TeamMatchTab({
  teamA,
  setTeamA,
  teamB,
  setTeamB,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How teams perform at different venues
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-gray-500">L 2</p>
                </div>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <div>
                  <p className="font-medium">Marvel Stadium</p>
                  <p className="text-sm text-gray-500">Docklands Stadium</p>
                </div>
                <div className="text-right">
                  <p className="font-bold text-green-600">W 6</p>
                  <p className="text-sm text-gray-500">L 4</p>
                </div>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                <div>
                  <p className="font-medium">Adelaide Oval</p>
                  <p className="text-sm text-gray-500">Adelaide, SA</p>
                </div>
                <div className="text-right">
                  <p className="font-bold text-green-600">W 5</p>
                  <p className="text-sm text-gray-500">L 3</p>
                </div>
              </div>
            </div>
          </CardContent>
