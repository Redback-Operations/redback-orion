...
class CongestionDetection:
            ...
            try:
                ...
                for clusterID in uniqueClusters:
                    ...
                    if len(clusterPoints) >= minCongestionThreshold:
                        ...
                        # Calculate the radius based on the maximum distance from the center
                        maxDistance = 0
    ...
    def _fallbackCongestionDetection(self, position):
        ...
        # Iterate through each position and check for nearby points
    ...
    def predictCongestionZones(self, currentPositions, flow, predictScale=5):
        ...
        # Define a list to store predicted congestion zones
        futurePositions = []
        ...
        # identify congestion zones based on the predicted future positions
        if len(futurePositions) >= self.congestionThreshold:
            ...
            # Fallback if the number of future positions is less than the threshold
            self._fallbackFutureCongestion(futurePositions, futureCongestions)
    ...
    def drawCongestionZones(
        ...
        for zone in self.congestionZones:
            ...
            # Draw the congestion zone on the annotated frame
            # the reddish circle is drawn on the floor plan with transparency
            ...
            # Filled the circle with text and people count
            ...
            if floorFrame is not None and transformePointsFuction is not None:
                # Draw the congestion zone on the floor plan
    ...
    def drawPredictedCongestion(self, annotatedFrame, predictedCongestions):
        ...
        for zone in predictedCongestions:
            ...
            cv2.circle(overlay, center, radius, (255, 200, 0), -1)  # Pale blue color
