...
const PlayerMovement = () => {
    ...
    return (
        <div className='p-4 bg-gradient-to-r from-purple-900 to-orange-500'>
            <BackButton />
            <h1 className='text-3xl my-4 font-bold text-black text-center hover:text-white hover:underline'>Player Movement Details</h1>
            {loading ? (
                <Spinner />
            ) : (
                <div>
                    ...
                    <div>
                        <h2 className='text-lg mb-2 font-bold text-center hover:text-white hover:underline'>Altitude Over Time</h2>
                        <svg ref={svgRef} width="400" height="300"></svg>

                        <h2 className='text-lg mb-2 font-bold text-center hover:text-white hover:underline'>Satellite Count Over Time</h2>
                        <svg ref={svgRef} width="400" height="300"></svg>
                    </div>
                </div>
            )}
